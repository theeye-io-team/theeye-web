...
Toda la información está guardada en strings o estructuras JSON, y puede consultarla mediante las variables de entorno del script. [Más información](https://documentation.theeye.io/theeye-supervisor/#/runtime-info)
