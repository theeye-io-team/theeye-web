    ...
    <div data-component="task-credentials">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <span class="input-group-btn">
            <button class="btn btn-primary" type="button" data-hook="copy_task_id">
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <span class="input-group-btn">
            <button class="btn btn-primary" type="button" data-hook="copy_task_secret">
              <span class="fa fa-copy" alt="copy to clipboard"></span>
            </button>
          </span>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <span class="input-group-btn">
            <button class="btn btn-primary" type="button"  data-hook="copy_task_url">
              <span class="fa fa-copy" alt="copy to clipboard"></span>
            </button>
          </span>
        </div>
...
curl -i -sS -X POST '<span data-hook="curl_api_url"></span>' \\
  ...
  --data '{"task_arguments":[<span data-hook="task_args"></span>]}'
          ...
          <a href="${config.docs}/${docsLink}" target="_blank">
  ...
  props: {
    ...
    args: 'string',
    argsVar: 'string',
    syncToggle: ['boolean', false, false],
  ...
  updateState () {
    ...
    const baseUrl = `${config.supervisor_api_url}/task/${this.id}`
    const query = { }
