...
export default {
  remove: function(id){
    ...
    webhook.destroy({
      success: function(){
        App.state.alerts.success('Done', 'Webhook removed')
  ...
  //      bootbox.alert(
  //        `${count} the delete request came back with error. Reloding now...`,() => {
  ...
  update: function(id,data){
    ...
    webhook.save({},{
      ...
      success: function(){
        App.state.alerts.success('Done', 'Webhook updated')
  ...
  create: function(data){
    ...
    webhook.save({},{
      success: function(){
        App.state.alerts.success('Done', 'Webhook created')
  ...
  trigger: function(webhook){
    $.ajax({
      ...
      App.state.alerts.success('Done', 'Webhook triggered')
    }).fail(function(xhr,status){
      App.state.alerts.danger('Error', 'Webhook not triggered')
    });
  }
}
